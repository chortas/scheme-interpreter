...
(deftest evaluar-define-test
  (testing "Funcion evaluar-define"
    ...
    (is (= "((;ERROR: define: missing or extra expression (define)) (x 1))") (evaluar-define '(define) '(x 1)))
    (is (= "((;ERROR: define: missing or extra expression (define x)) (x 1))") (evaluar-define '(define x) '(x 1)))
    (is (= "((;ERROR: define: missing or extra expression (define x 2 3)) (x 1))") (evaluar-define '(define x 2 3) '(x 1)))
    (is (= "((;ERROR: define: missing or extra expression (define ())) (x 1))") (evaluar-define '(define ()) '(x 1)))
    (is (= "((;ERROR: define: bad variable (define () 2)) (x 1))") (evaluar-define '(define () 2) '(x 1)))
    (is (= "((;ERROR: define: bad variable (define 2 x)) (x 1))") (evaluar-define '(define 2 x) '(x 1)))
    )
)
